...
verdes = ['folha','grama','lagarta','trevo']
vermelhas = ['morango','tomate','cereja','flor']
amarelas = ['estrela','sol','banana','mel']
azuis = ['mirtilo','oceano','baleia','flor']

verde = choice(verdes).upper()
vermelho = choice(vermelhas).upper()
amarelo = choice(amarelas).upper()
azul = choice(azuis).upper()
